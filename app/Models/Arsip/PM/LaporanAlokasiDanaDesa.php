...
class LaporanAlokasiDanaDesa extends Model
{
    protected $table = 'pm_laporan_alokasi_dana_desa';
    ...
    {
        $file = $this->file()->whereJenisArsip(File::LAPORAN_ALOKASI_DANA_DESA)->first();
        if ($file) {
            $lokasi = $file->lokasi;
