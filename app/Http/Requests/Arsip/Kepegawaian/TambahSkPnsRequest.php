...
class TambahSkPnsRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'file.required' => 'File SK PNS harus ada.',
            'file.array' => 'Format input file SK PNS salah.',
            'file.*.required' => 'File SK PNS harus ada.',
            'file.*.mimes' => 'Format file SK PNS yg disarankan : .pdf',
        ];
    }
}