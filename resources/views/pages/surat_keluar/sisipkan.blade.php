...
@include('components.header', [
    'link' => route('surat_keluar'),
    'text_link' => 'Daftar Surat Keluar'
])
@endsection
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="{{ route('sisipkan_surat_keluar') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-control-label" for="nomor_surat">Nomor Indeks Surat</label>
                    ...
                    <button class="btn btn-primary" type="submit">Sisipkan Surat Keluar</button>
                </form>
            </div>
        </div>
    </div>
