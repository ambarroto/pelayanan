...
@include('components.header', [
    'link' => route('dispensiasi_nikah'),
    'text_link' => "Daftar Dispensiasi Nikah"
])
@endsection
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Tambah Data Dispensiasi Nikah</h3>
            </div>
            <div class="card-body">
                @if(session('error'))
                ...
                <form class="needs-validation" novalidate action="{{ route('input_dispensiasi_nikah') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                    ...
                    <button class="btn btn-primary" type="submit">Tambah Dispensiasi Nikah</button>
                </form>
            </div>
        </div>
    </div>
