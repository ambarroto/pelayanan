...
@include('components.header', [
    'link' => route('arsip_laporan_realisasi_apbdes'),
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="{{ route('simpan_arsip_laporan_alokasi_dana_desa') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('anggaran') is-invalid @enderror" id="anggaran" name="anggaran" placeholder="Anggaran" value="{{ old("anggaran") }}">
                            @error('anggaran')
                            <div class="invalid-feedback">
                            {{ $message }}
                            </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-control-label" for="realisasi">Realisasi</label>
                            <input type="text" class="form-control @error('realisasi') is-invalid @enderror" id="realisasi" name="realisasi" placeholder="Realisasi" value="{{ old("realisasi") }}">
                            @error('realisasi')
                            <div class="invalid-feedback">
                            {{ $message }}
                            </div>
