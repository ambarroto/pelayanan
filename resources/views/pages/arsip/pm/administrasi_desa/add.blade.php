    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="{{ route('simpan_arsip_administrasi_desa') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label class="form-control-label" for="peruntukan">Peruntukan</label>
                            <input type="text" class="form-control @error('peruntukan') is-invalid @enderror" id="peruntukan" name="peruntukan" placeholder="Peruntukan" value="{{ old("peruntukan") }}">
                            @error('peruntukan')
                            <div class="invalid-feedback">
                            {{ $message }}
                            </div>
