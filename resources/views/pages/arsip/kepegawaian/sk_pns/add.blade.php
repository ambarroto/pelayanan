    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Tambah Data SK PNS</h3>
            </div>
            <div class="card-body">
                @if(session('error'))
                ...
                <form class="needs-validation" novalidate action="{{ route('simpan_arsip_sk_pns') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label class="form-control-label" for="file">File SK PNS</label>
